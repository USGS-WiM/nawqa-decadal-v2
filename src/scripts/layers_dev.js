    ...
    allLayers = [//
        {
            ...
            "layers": {
                "All Networks": {
                    "url": "https://gis1.wim.usgs.gov/server/rest/services/NAWQA/2023_networksdata/MapServer/0", //PROD == NAWQA/decadal
                    "options": {
                        "id": "allNetworks",
                        /* "visibleLayers": [0], */
                    ...
                    "url": "https://gis1.wim.usgs.gov/server/rest/services/NAWQA/2023_networkpolys/MapServer",
                    "visibleLayers": [1],
                    "options": {
                ...
                "Magnitude of change": {
                    "url": "https://gis1.wim.usgs.gov/server/rest/services/NAWQA/2023_networksdata/MapServer/0",
                    "options": {
                        "id": "networkLocations",
                        /* "visibleLayers": [0], */
                        "mode": FeatureLayer.MODE_SNAPSHOT,
                 ...
                 "Land use 2001" : {
                    ...
                    "url": "https://gis1.wim.usgs.gov/server/rest/services/NAWQA/2023_trend_sites/MapServer",
                    "options": {
                        "id": "trendSites",
                        "opacity": 1.0,
                        "visible": false
                    ...
                    "url": "https://gis1.wim.usgs.gov/server/rest/services/NAWQA/2023_networksdata/MapServer", //PROD == NAWQA/decadal
                    "visibleLayers": [2],
                    "options": {
                        "id": "glacialAquifer",
                        "opacity": 0.4,
